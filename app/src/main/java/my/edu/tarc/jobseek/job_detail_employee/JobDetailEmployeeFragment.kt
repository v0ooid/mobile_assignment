...
class JobDetailEmployeeFragment : Fragment() {
    private var _binding: FragmentJobDetailEmployeeBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJobDetailEmployeeBinding.inflate(inflater, container, false)
        return binding.root
    }
